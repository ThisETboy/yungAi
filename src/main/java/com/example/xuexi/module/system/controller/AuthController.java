package com.example.xuexi.module.system.controller;

import com.example.xuexi.common.response.R;
import com.example.xuexi.common.util.JwtUtil;
import com.example.xuexi.module.system.dto.LoginRequest;
import com.example.xuexi.module.system.dto.LoginResponse;
...
import com.example.xuexi.module.system.vo.UserInfoVO;
...
public class AuthController {
    ...
    public R<LoginResponse> login(@Valid @RequestBody LoginRequest request) {
        ...
        String accessToken = jwtUtil.generateToken(
                1L, request.getUsername(), Map.of("role", "ADMIN"));
